...
RegisterNUICallback('updateSkin', function(data)
	...
	if(v == true) then
		...
		SetCustomization(dad, mum, dadmumpercent, skin, eyecolor, acne, skinproblem, freckle, wrinkle, wrinkleopacity, eyebrow, eyebrowopacity, beard, beardopacity, beardcolor, hair, haircolor, torso, torsotext, leg, legtext, shoes, shoestext, accessory, accessorytext, undershirt, undershirttext, torso2, torso2text, prop_hat, prop_hat_text, prop_glasses, prop_glasses_text, prop_earrings, prop_earrings_text, prop_watches, prop_watches_text)
	end
end)

RegisterNetEvent("vRP_C:playerSpawned")
AddEventHandler("vRP_C:playerSpawned", function(dad, mum, dadmumpercent, skin, eyecolor, acne, skinproblem, freckle, wrinkle, wrinkleopacity, eyebrow, eyebrowopacity, beard, beardopacity, beardcolor, hair, haircolor, torso, torsotext, leg, legtext, shoes, shoestext, accessory, accessorytext, undershirt, undershirttext, torso2, torso2text, prop_hat, prop_hat_text, prop_glasses, prop_glasses_text, prop_earrings, prop_earrings_text, prop_watches, prop_watches_text)
	SetCustomization(dad, mum, dadmumpercent, skin, eyecolor, acne, skinproblem, freckle, wrinkle, wrinkleopacity, eyebrow, eyebrowopacity, beard, beardopacity, beardcolor, hair, haircolor, torso, torsotext, leg, legtext, shoes, shoestext, accessory, accessorytext, undershirt, undershirttext, torso2, torso2text, prop_hat, prop_hat_text, prop_glasses, prop_glasses_text, prop_earrings, prop_earrings_text, prop_watches, prop_watches_text)
end)
...
function SetCustomization(dad, mum, dadmumpercent, skin, eyecolor, acne, skinproblem, freckle, wrinkle, wrinkleopacity, eyebrow, eyebrowopacity, beard, beardopacity, beardcolor, hair, haircolor, torso, torsotext, leg, legtext, shoes, shoestext, accessory, accessorytext, undershirt, undershirttext, torso2, torso2text, prop_hat, prop_hat_text, prop_glasses, prop_glasses_text, prop_earrings, prop_earrings_text, prop_watches, prop_watches_text)
...
function texthelphaineALEX(str)
...
local locations = {
	{1932.76989746094, 3727.73510742188, 32.8444557189941},
	{1693.26, 4822.27, 42.06},
	{125.83, -223.16, 54.55},
	{-710.16, -153.26, 37.41},
	{-821.69, -1073.90, 11.32},
	{-1192.81, -768.24, 17.31},
	{4.25, 6512.88, 31.87},
	{425.471, -806.164, 29.4911},
	{-284.1448059082,6136.87890625,31.500102996826}
}
...
Citizen.CreateThread(function()
	while true do
		...
		for i,v in pairs(locations) do
			if Vdist(v[1],v[2],v[3],playerPos.x,playerPos.y,playerPos.z) < 3 then
				DrawMissionText2("Apasa ~g~E~w~ pentru a te schimba~w~!",10)
			...
			if Vdist(v[1],v[2],v[3],playerPos.x,playerPos.y,playerPos.z) <= 12.0 then
				DrawMarker(41,v[1], v[2], v[3],0, 0, 0, 0, 0, 0, 1.001,1.001,1.001,255,255,255,200,0,0,0,true)
			end
		end
	end
end)
...
Citizen.CreateThread(function()
	...
	for i,v in pairs(locations) do
		...
		AddTextComponentString("Imbracaminte")
